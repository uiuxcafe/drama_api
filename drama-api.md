...
- 條件
    1. 類別分為：美劇、陸劇、韓劇、日劇、台劇 共五類。
    2. 一頁顯示 10 篇文章。
    3. 預設採用 **討論最新發佈時間** 排序顯示列表。
    4. 熱門列表 等待後端資料齊全再開發

### 最新列表
_進入討論首頁時，打此 api，討論列表即依據 **最新發佈時間由上至下**顯示列表。_
...
- 條件
    1. 依據搜尋關鍵字，分別顯示三種類型的結果列表。
    2. 搜尋類型分為三種：新聞、戲劇、討論。
    3. 每一類型搜尋結果均回傳 3 筆資料。
    4. 結果列表請以 **最新發佈時間** 排序，由上至下排序。
