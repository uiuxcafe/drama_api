...
- [2. 戲劇區（目前戲劇後端爬蟲有困難）](#2-戲劇區目前戲劇後端爬蟲有困難)
  - [2.1 取得熱門精選 [Banner]](#21-取得熱門精選-banner)
  - [2.2 取得最新列表](#22-取得最新列表)
  - [2.3 取得熱門列表 [預設]](#23-取得熱門列表-預設)
  - [2.4 取得詳細資料](#24-取得詳細資料)
- [3. 討論區](#3-討論區)
  - [3.1 取得最新列表](#31-取得最新列表)
  - [3.2 取得詳細資料](#32-取得詳細資料)
  - [3.3 取得熱門精選 [Banner]（等待後端資料齊全後開發）](#33-取得熱門精選-banner等待後端資料齊全後開發)
  - [3.4 取得熱門列表（等待後端資料齊全後開發）](#34-取得熱門列表等待後端資料齊全後開發)
- [4. 搜尋](#4-搜尋)
...
## 3.3 取得熱門精選 [Banner]（等待後端資料齊全後開發）
_進入討論首頁時，依據各地區打此 api，取得該地區每天精選 5 篇熱門討論 **（以平台留言數為主）**。_

## 3.4 取得熱門列表（等待後端資料齊全後開發）
...
## 6.1 取得篩選列表
_選擇類別、地區、年份篩選後，打此 API，更新列表資料。_
